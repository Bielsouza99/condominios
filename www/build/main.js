        ...
        if (this.form.valid) {
            this.provider.salvar(this.form.value)
                ...
                _this.calendar.createEvent(_this.evento.nome, _this.evento.local, 'Evento', _this.evento.calendario)
                    .then(function () { return _this.toast.create({ message: 'Evento salvo na sua agenda com sucesso', duration: 5000 }).present(); })
                    .catch(function (e) { return _this.toast.create({ message: 'Erro ao salvar evento na sua agenda', duration: 5000 }); });
                _this.navCtrl.pop();
            })
                .catch(function (e) {
