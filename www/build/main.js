    ...
    EditarEventoPage.prototype.enviar = function () {
        ...
        if (this.form.valid) {
            this.provider.salvar(this.form.value)
                ...
                _this.calendar.createEvent(_this.evento.nome, _this.evento.local, 'Evento', _this.evento.calendario)
                    .then(function () { return console.log('integrou com o calendario'); })
                    .catch(function (e) { return console.log('não integrou com o calendario'); });
                _this.navCtrl.pop();
            })
                .catch(function (e) {
